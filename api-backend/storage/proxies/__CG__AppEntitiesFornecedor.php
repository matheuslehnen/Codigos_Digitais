 ...
 */
class Fornecedor extends \App\Entities\Fornecedor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entities\\Fornecedor' . "\0" . 'id', '' . "\0" . 'App\\Entities\\Fornecedor' . "\0" . 'cpfCnpj', '' . "\0" . 'App\\Entities\\Fornecedor' . "\0" . 'nome', '' . "\0" . 'App\\Entities\\Fornecedor' . "\0" . 'telefone', '' . "\0" . 'App\\Entities\\Fornecedor' . "\0" . 'endereco'];
        }
